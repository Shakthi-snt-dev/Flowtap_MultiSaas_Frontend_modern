...
import { ClipboardList, ShieldCheck, LayoutGrid } from 'lucide-react'
...
const repairNav = [
  { label: 'Check-Ins',    href: '/check-ins',    icon: <ClipboardList className="w-5 h-5" /> },
  { label: 'Repair Board', href: '/repair-board', icon: <LayoutGrid    className="w-5 h-5" /> },
