...
const OnboardingPage        = React.lazy(() => import('@flowtap/pages-core').then((m) => ({ default: m.MedicalOnboardingPage })))
...
const AppointmentsPage  = React.lazy(() => import('./pages/AppointmentsPage').then((m) => ({ default: m.AppointmentsPage })))
const ConsultationsPage = React.lazy(() => import('./pages/ConsultationsPage').then((m) => ({ default: m.ConsultationsPage })))

const medicalNav = [
  { label: 'Patients',      href: '/patients',      icon: <Users        className="w-5 h-5" /> },
  { label: 'Appointments',  href: '/appointments',  icon: <CalendarCheck className="w-5 h-5" /> },
  { label: 'Consultations', href: '/consultations', icon: <Stethoscope  className="w-5 h-5" /> },
]
    ...
    <React.Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route element={<ProtectedRoute requireTenant />}>
          <Route element={<AppLayout extraNavItems={medicalNav} />}>
